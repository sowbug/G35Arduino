/*
  ...
  This file (DigitalWriteFast.h) was taken from
  http://code.google.com/p/digitalwritefast/ and did not contain a copyright
  notice. If you wish to distribute this file, please obtain the original from
  that source rather than assuming that the license statement above applies to
  it.
*/
